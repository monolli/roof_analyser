...
api_key = 'abIjC8gT9LV1tdnoeSgX8XEOYri7KXUSD9ggR9EL'
...
your_name = 'Henrique+Oliveira'
# Your reason for using the NSRDB.
reason_for_use = 'predicting+residential+PV+potential'
# Your affiliation
your_affiliation = 'University+of+Southern+California'
# Your email address
your_email = 'henriqut@usc.edu'
